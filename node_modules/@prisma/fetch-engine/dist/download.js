...
exports.getBinaryEnvVarPath = exports.getBinaryName = exports.checkVersionCommand = exports.getVersion = exports.download = void 0;
...
async function download(options) {
    ...
    if (['arm', 'nixos'].includes(os.distro)) {
        ...
        console.error(`${chalk_1.default.yellow('Warning')} Precompiled binaries are not available for ${platform}.`);
    }
